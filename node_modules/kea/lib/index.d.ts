...
type AnyComponent = ComponentType | FunctionComponent;
...
type BuiltLogic<LogicType extends Logic = Logic> = LogicType & BuiltLogicAdditions<LogicType>;
...
type LogicWrapper<LogicType extends Logic = Logic> = LogicType & LogicWrapperAdditions<LogicType>;
...
type ReducerActions<LogicType extends Logic, ReducerType> = LogicType['__keaTypeGenInternalReducerActions'] extends Record<string, never> ? {
...
type ReducerDefault<Reducer extends () => any, P extends Props> = ReturnType<Reducer> | ((state: any, props: P) => ReturnType<Reducer>);
...
type ReducerFunction<S = any> = (state: S, action: KeaReduxAction, fullState: any) => S;
type SelectorTuple = [] | [Selector] | [Selector, Selector] | [Selector, Selector, Selector] | [Selector, Selector, Selector, Selector] | [Selector, Selector, Selector, Selector, Selector] | [Selector, Selector, Selector, Selector, Selector, Selector] | [Selector, Selector, Selector, Selector, Selector, Selector, Selector] | [Selector, Selector, Selector, Selector, Selector, Selector, Selector, Selector] | [Selector, Selector, Selector, Selector, Selector, Selector, Selector, Selector, Selector] | [Selector, Selector, Selector, Selector, Selector, Selector, Selector, Selector, Selector, Selector] | [Selector, Selector, Selector, Selector, Selector, Selector, Selector, Selector, Selector, Selector, Selector];
type SelectorDefinition<Selectors, PropSelectors, SelectorFunction extends any> = [(s: Selectors, p: PropSelectors) => SelectorTuple, SelectorFunction] | [(s: Selectors, p: PropSelectors) => SelectorTuple, SelectorFunction, DefaultMemoizeOptions];
type LogicPropSelectors<LogicType extends Logic> = {
    [PK in keyof LogicType['props']]: () => LogicType['props'][PK];
};
type SelectorDefinitions<LogicType extends Logic> = {
    [K in keyof LogicType['__keaTypeGenInternalSelectorTypes']]?: SelectorDefinition<LogicType['selectors'], LogicPropSelectors<LogicType>, LogicType['__keaTypeGenInternalSelectorTypes'][K]>;
} | {
...
type ConnectDefinitions = BuiltLogic | LogicWrapper | (BuiltLogic | LogicWrapper)[] | {
    logic?: (BuiltLogic | LogicWrapper)[];
    values?: any[];
    actions?: any[];
};
type LogicInput<LogicType extends Logic = Logic> = {
...
interface MakeLogicType<Values extends Record<string, any> = Record<string, unknown>, Actions = Record<string, AnyFunction>, LogicProps = Props> extends Logic {
    ...
    asyncActions: {
        [ActionKey in keyof Actions]: Actions[ActionKey] extends AnyFunction ? AsyncActionForPayloadBuilder<Actions[ActionKey]> : never;
    };
    defaults: Values;
    props: LogicProps;
...
interface KeaLogicType<Input extends KeaLogicTypeInput> extends Logic {
    actionCreators: {
        [ActionKey in keyof Input['actions']]: Input['actions'][ActionKey] extends AnyFunction ? ActionCreatorForPayloadBuilder<Input['actions'][ActionKey]> : never;
    };
    actionKeys: Record<string, string>;
    actionTypes: {
    ...
    actions: {
        [ActionKey in keyof Input['actions']]: Input['actions'][ActionKey] extends AnyFunction ? ActionForPayloadBuilder<Input['actions'][ActionKey]> : never;
    };
    ...
    __keaTypeGenInternalSelectorTypes: Input['__keaTypeGenInternalSelectorTypes'] extends Record<string, any> ? Input['__keaTypeGenInternalSelectorTypes'] : Record<string, any>;
    __keaTypeGenInternalReducerActions: Input['__keaTypeGenInternalReducerActions'] extends Record<string, any> ? Input['__keaTypeGenInternalReducerActions'] : Record<string, any>;
    __keaTypeGenInternalExtraInput: Input['__keaTypeGenInternalExtraInput'] extends Record<string, any> ? Input['__keaTypeGenInternalExtraInput'] : Record<string, any>;
}
...
type AsyncActionForPayloadBuilder<B extends AnyFunction> = (...args: Parameters<B>) => Promise<any>;
...
declare function useAsyncActions<L extends Logic = Logic>(logic: BuiltLogic<L> | LogicWrapper<L>): L['asyncActions'];
...
declare function setPluginContext<Context extends Record<string, any> = Record<string, any>>(name: string, pluginContext: Context): void;
